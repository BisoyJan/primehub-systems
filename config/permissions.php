    ...
    */
    'role_permissions' => [
        ...
        'team_lead' => [
            ...
            'stations.view',
            'stocks.view',
            'pc_transfers.view', 'pc_transfers.history',
            'pc_maintenance.view', 'pc_maintenance.create', 'pc_maintenance.edit',
            'attendance.view', 'attendance.review', 'attendance.verify', 'attendance.statistics',
            'schedules.view',
            'biometric.view',
            'attendance_points.view', 'attendance_points.export',
            'leave.view', 'leave.create', 'leave.view_all',
        ...
        'hr' => [
            ...
            'biometric.view', 'biometric.reprocess', 'biometric.anomalies', 'biometric.export', 'biometric.retention',
            'attendance_points.view', 'attendance_points.excuse', 'attendance_points.export', 'attendance_points.rescan',
            'leave.view', 'leave.approve', 'leave.deny', 'leave.view_all',
            'settings.account', 'settings.password',
        ],
