...
class SocialGroupMessageCreated implements ShouldBroadcastNow
{
    ...
    {
        return new PrivateChannel('social.group.'.$this->message->social_group_id);
    }

    public function broadcastAs(): string
    {
        return 'social.group.message.created';
    }
    ...
    public function broadcastWith(): array
    {
        ...
        return [
            'id' => $this->message->id,
            'social_group_id' => $this->message->social_group_id,
