...
class FixAttendancePointAnomalies extends Command
{
    ...
    protected $description = 'Fix attendance point data anomalies: overdue SRO, stale GBRO dates on non-eligible records, and month-end expires_at overflow';
    ...
    public function handle(): int
    {
        ...
        // ── Fix 3: Recalculate expires_at for month-end overflow ────────────────
        ...
        if (! $this->option('skip-expires-at')) {
            $this->info('Fix 3: Correcting month-end expires_at overflow...');

            // FTN: whole_day_absence, is_advised=0, eligible_for_gbro=0 → +1 year NoOverflow
