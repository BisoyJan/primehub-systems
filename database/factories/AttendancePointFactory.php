...
class AttendancePointFactory extends Factory
{
    ...
    /**
     * Indicate that the point is a manual entry.
     */
    public function manual(?User $createdBy = null): static
    {
        return $this->state(fn (array $attributes) => [
            'attendance_id' => null,
            'is_manual' => true,
            'created_by' => $createdBy?->id ?? User::factory(),
        ]);
    }

    /**
     * Indicate that the point is auto-generated (not manual).
     */
