...
export const THEMES: TimerTheme[] = [
    ...
    // 13. Desktop Goose — Interactive goose that roams and chases cursor
    {
        ...
        name: 'Desktop Goose',
        icon: '🪿',
        quote: 'Honk honk! Take a break!',
        alwaysDark: false,
        bgLight: 'linear-gradient(180deg, #e8f5e9 0%, #c8e6c9 40%, #a5d6a7 100%)',
        bgDark: 'linear-gradient(180deg, #1b2e1b 0%, #263826 40%, #2e4a2e 100%)',
        glassLight: 'rgba(255,255,255,0.4)',
        glassDark: 'rgba(30,50,30,0.5)',
        ringActive: '#ff9800',
        ringPaused: '#78909c',
        ringOverage: '#ffc107',
        ringDanger: '#f44336',
        ringTrack: '#c8e6c9',
        ringTrackDark: '#2e4a2e',
        ringGlow: false,
        ringAnimated: false,
        statusActive: ['#e65100', '#ffb74d'],
        statusPaused: ['#546e7a', '#90a4ae'],
        statusOverage: ['#f57f17', '#ffd54f'],
        statusDanger: ['#c62828', '#ef5350'],
        btnBreak: { from: '#ff9800', to: '#f57c00' },
        btnLunch: { from: '#8bc34a', to: '#689f38' },
        btnCombined: { from: '#ff9800', to: '#689f38' },
        btnCombinedBreak: { from: '#4caf50', to: '#388e3c' },
        btnPause: { from: '#78909c', to: '#546e7a' },
        btnResume: { from: '#ff9800', to: '#f57c00' },
        btnEnd: { from: '#546e7a', to: '#37474f' },
    },
];
